...
export const routerFirmwareProvider: IntegrationProvider = {
  ...
  routerConfig: {
    ...
    Router: {
      default: 'firmware,claude-opus-4-6',
      think: 'firmware,claude-opus-4-6',
      background: 'firmware,claude-haiku-4-5',
      web_search: 'firmware,claude-haiku-4-5',
      long_context: 'firmware,claude-sonnet-4-5',
    },
  },
};